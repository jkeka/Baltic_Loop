...
<qgis simplifyAlgorithm="0" labelsEnabled="0" maxScale="0" simplifyLocal="1" readOnly="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.4.15-Madeira">
    ...
    <symbols>
      <symbol type="line" force_rhr="0" alpha="1" clip_to_extent="1" name="0">
        <layer pass="0" locked="1" class="SimpleLine" enabled="1">
          ...
          <prop v="255,29,32,255" k="line_color"/>
  ...
  <aliases>
    ...
    <alias index="1" name="" field="Fbaccess"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="id"/>
    <default applyOnUpdate="0" expression="" field="Fbaccess"/>
  </defaults>
  <constraints>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="id"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="Fbaccess"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="id"/>
    <constraint exp="" desc="" field="Fbaccess"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="Fbaccess" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="Fbaccess"/>
    <field editable="1" name="id"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="Fbaccess"/>
